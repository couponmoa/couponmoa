...
class UserCouponServiceTest {
    ...
    class CreateUserCouponTests {
        ...
        void 쿠폰_발급_쿠폰_없음_실패() {
            ...
            given(couponRepository.findByIdOrElseThrow(anyLong(), any(ErrorCode.class)))
        ...
        void 쿠폰_발급_기간_전_요청_실패() {
            ...
            given(couponRepository.findByIdOrElseThrow(anyLong(), any(ErrorCode.class))).willReturn(coupon);
