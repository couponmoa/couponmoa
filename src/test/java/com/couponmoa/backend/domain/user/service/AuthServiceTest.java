...
public class AuthServiceTest {
    ...
    class signup {
        ...
        void 이미_존재하는_계정으로_회원가입_시_예외() {
            ...
            ApplicationException exception = assertThrows(ApplicationException.class, () -> authService.signup(signupRequest));
    ...
    class signin {
        ...
        void 사용자_정보_불일치_시_예외() {
            ...
            ApplicationException exception = assertThrows(ApplicationException.class, () -> authService.signin(signinRequest));
    ...
    class refreshToken {
        ...
        void 사용자_정보_불일치_시_예외() {
            ...
            ApplicationException exception = assertThrows(ApplicationException.class, () -> authService.refreshToken(refreshToken));
            assertEquals(ErrorCode.USER_NOT_FOUND.getHttpStatus(), exception.getStatus());
        }
